...
import com.sst.ngisiyuk.viewmodels.FCMVIewModel
...
class TopUpFragment : Fragment(), HideKeyboard, ThousandSeparator {
    ...
    private val fcmVM by activityViewModels<FCMVIewModel>()
    ...
    override fun onCreateView(
        ...
        topUpModel.topUpResponse.observe(viewLifecycleOwner,{ topUpResponse ->
            println(topUpResponse)
        ...
        fcmVM.token.observe(viewLifecycleOwner,{
            if(it != ""){
                handleFCM(it)
            }
        })
    ...
    private fun handleFCM(token: String) {
        topUpModel.updateToken(id,token)
    }
